          ...
          <div>
            ...
            <RadioAreaGroup.Group
              ...
              onValueChange={(val: string) =>
                form.setValue("schedulingType", val as SchedulingType, { shouldValidate: true })
              }
              className="flex flex-col gap-2">
              <RadioAreaGroup.Item value={SchedulingType.COLLECTIVE}>
                <strong>{t("collective")}</strong>
                <p className="text-subtle">{t("collective_description")}</p>
              </RadioAreaGroup.Item>
              <RadioAreaGroup.Item value={SchedulingType.ROUND_ROBIN}>
                <strong>{t("round_robin")}</strong>
                <p className="text-subtle">{t("round_robin_description")}</p>
              </RadioAreaGroup.Item>
              <RadioAreaGroup.Item value={SchedulingType.MANAGED}>
                <strong>{t("managed_event")}</strong>
