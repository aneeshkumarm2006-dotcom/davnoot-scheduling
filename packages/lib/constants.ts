...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://davnoot.com";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Davnoot";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "support@davnoot.com";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Davnoot";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Davnoot";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Davnoot";
...
// Davnoot Video (Daily) app identifiers
